...
class WCDQA:
    ...
    def __init__(self, model = "default"):
        if(model == "default"):
            self.model =  gensim.models.Word2Vec.load_word2vec_format('/home/ssamot/projects/wmd-python/GoogleNews-vectors-negative300.bin', binary=True)
        else:
            self.model = model
    ...
    def processqawmd(self, question, data ):
        ...
        vec_size = 300
        lines = [question] + data
        X, BOW_X = self._process_data(lines, vec_size)
